...
[目標 System Design](../docs/SYSTEM_DESIGN.md) 第 9 節描述下一版 API 草案，與本目錄的 v0.1 尚不相容。`revise`、逐張 Reject、`all_rejected`、`decision_session`、`preference_revision_id`、有來源的偏好及五家 Seller／五輪／共享 context 都需契約升版；本次文件整併未變更現有 schema 或 fixtures。
