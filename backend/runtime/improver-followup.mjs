...
export function ensureImprovementChild(store,job){
  return store.transaction(()=>{
    ...
    const child=store.create(w.buyer_id,documents,{parent_request_id:parent.request_id,root_request_id:parent.root_request_id,revision:documents.revision}).body;
