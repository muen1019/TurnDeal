...
assert.deepEqual(Object.keys(openapi.paths).filter(p=>!p.includes('purchase')&&!p.endsWith('/improvement')).sort(),['/api/requests','/api/requests/{request_id}','/api/requests/{request_id}/decisions']);
