export function mobileConfig(source,live=false){
 ...
 Object.assign(frontendEnv,{OFFERMESH_DEV_MOCK:'0',OFFERMESH_RUNTIME_MODE:live?'live':'offline',OFFERMESH_MOBILE_DEMO:'1',OFFERMESH_API_ORIGIN:`http://127.0.0.1:${apiPort}`});
