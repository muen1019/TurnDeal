...
本目錄只保留現行行為、操作方式與仍有效的設計。一次性的整合紀錄、舊草案及日期化測試結果由 Git history 保存。
...
- [intent.md／preference.md 語意](INTENT_PREFERENCE_SPEC.md)
- [共用 schema 說明](../contracts/README.md)
- [SQLite migrations](../db/README.md)
...
- [Seller policies](SELLER_POLICIES.md)
