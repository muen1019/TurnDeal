...
執行時間：2026-09-12T05:17:56.530Z；模式：live；模型：gpt-4.1-mini-2025-04-14；耗時：18.27 秒。
...
| --- | ---: | ---: | --- | ---: | --- |
| seller_a・願意讓價 | NT$559 | — | 5 天 | 5 | token_budget |
| seller_d・組合更便宜 | NT$630 | NT$600 | 2 天 | 3 | seller_final |
| seller_c・免費送周邊 | NT$619 | NT$619 | 3 天 | 5 | token_budget |
| seller_e・固定價格 | NT$679 | — | 4 天 | 1 | seller_final |
| seller_b・快速配送 | NT$710 | — | 1 天 | 4 | seller_final |
...
來源：deterministic_fallback；模型：gpt-4.1-mini-2025-04-14；耗時 5.38 秒；呼叫 1 次；API tokens 2544；fallback：ranking_preference_order。
...
| 3 | seller_c | standalone | NT$619 | 3 天 | 依價格優先排序；含稅運 NT$619，3 天到貨。 |
| 4 | seller_c | bundle | NT$619 | 3 天 | 依價格優先排序；含稅運 NT$619，3 天到貨。 |
...
| 4 | NT$679 | 單買 NT$559 | openai / openai |
| 5 | NT$619 | token_budget | — / — |

- standalone：offer_0122bcc5-b6c2-4003-887c-aa15ed853eab，有效期限 2026-09-12T05:28:07.365Z
...
| 輪次 | Buyer 還價目標 | Seller 回覆 | 執行來源 Buyer／Seller |
| --- | ---: | --- | --- |
| 1 | — | 單買 NT$669 / 組合 NT$639 | openai / openai |
| 2 | NT$669 | 單買 NT$639 / 組合 NT$609 | openai / openai |
| 3 | NT$659 | 單買 NT$630 / 組合 NT$600 | openai / openai |

- standalone：offer_2883917f-e04b-4828-abd2-151465cd4264，有效期限 2026-09-12T05:28:04.951Z
- bundle：offer_120254cc-02b3-48f3-b0b1-5064fdf74642，有效期限 2026-09-12T05:28:04.951Z
...
| 3 | NT$580 | 單買 NT$629 / 組合 NT$629 | openai / openai |
| 4 | — | 單買 NT$619 / 組合 NT$619 | openai / openai |
| 5 | — | token_budget | — / — |

- standalone：offer_dab272b7-243f-4cc9-977f-51caecb088b6，有效期限 2026-09-12T05:28:07.359Z
- bundle：offer_fc65281e-01ca-48ce-aa9d-4adeaa972f4f，有效期限 2026-09-12T05:28:07.359Z
...
- standalone：offer_00336dbc-16ba-44ee-8a52-39d2df4753bb，有效期限 2026-09-12T05:27:58.817Z
...
| 輪次 | Buyer 還價目標 | Seller 回覆 | 執行來源 Buyer／Seller |
| --- | ---: | --- | --- |
| 1 | — | 單買 NT$739 | openai / openai |
| 2 | NT$590 | 單買 NT$710 | openai / openai |
| 3 | NT$659 | 單買 NT$710 | openai / openai |
| 4 | NT$629 | 單買 NT$710 | openai / openai |

- standalone：offer_6810d0ad-507c-46a8-95de-b356a6930c00，有效期限 2026-09-12T05:28:07.301Z

## 模型與 fallback

HTTP 呼叫：33；API 已回報 token：42953；保守預留 token：248057。採用模型決策 32 次，fallback 0 次。
